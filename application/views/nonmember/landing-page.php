...
<div class="main-bg-image-section">
    <main role="main" data-base="">
        <div class="main-wrapper sem-wrapper sem-resp" style="background:url(<?php echo base_url() . 'resources/images/' . $page_details[0]['bg_img']; ?>) no-repeat #fbfbfb;height:600px">
