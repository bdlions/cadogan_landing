        ...
        <div class="form-background top-bottom-padding">
            <div class="row">
                <div class ="col-md-8 margin-top-bottom">
                   <?php echo form_open_multipart('admin/landingPage/update_landingpage_coloum/'.$coloum_info['id'].'/'.$coloum, array('id' => 'form_update_page', 'class' => 'form-horizontal')); ?>
                            ...
                            <div class=" col-md-4">
                                <div class="profile-picture-box" >
                                    <div id="files" class="files">
                                        <?php if(!empty($image)): ?>
                                            <img style="width: 120px; height: 80px;" src="<?php echo base_url() . IMAGE_UPLOAD_PATH . $image; ?>" class="img-responsive"/>
                                        <?php endif; ?>
                                        <br>
                                    </div>
                                </div>
