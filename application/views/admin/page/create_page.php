...
$(function () {
    $("#btnSubmit").on("click", function(){
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: '<?php echo base_url();?>admin/page/create_page',
    ...
    var url = "<?php echo base_url();?>admin/page/create_page",
    ...
    $('#fileupload').fileupload({
        url: url,
        dataType: 'json',
        formData: $("form_create_page").serializeArray(),
        autoUpload: false,
        ...
        <div class="form-background top-bottom-padding">
            <div class="row">
                <div class ="col-md-8 margin-top-bottom">
                    <?php echo form_open("admin/page/create_page", array('id' => 'form_create_page', 'class' => 'form-horizontal', 'onsubmit' => 'return false;')); ?>
                    <div class ="row">
