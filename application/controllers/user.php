...
class User extends CI_Controller {
    ...
    {
        $this->data['page_details'] = $this->page_model->get_landing_pages()->result_array();
        $this->template->load(NULL, 'nonmember/landing-page',$this->data);
    }   
    ...
    public function menu($menu_id)
    {
		if($menu_id == 9){
			$this->data['page_details'] = $this->page_model->get_landing_pages()->result_array();
			$this->load->view('nonmember/landing-page',$this->data);
		}
		else{
