...
$config['tables']['logo_types']                 = 'logo_types';
$config['tables']['logos']                      = 'logos';
$config['tables']['gallery_images']             = 'gallery_images';
$config['tables']['home_page_info']             = 'home_page_info';
$config['tables']['links']                      = 'links';
$config['tables']['menus']                      = 'menus';
$config['tables']['submenus']                   = 'submenus';
...
$config['page_identity_column']                 = 'title';
...
$config['use_feedback_email'] = TRUE;
